...
class KokoroTTSEngine:
    ...
    def load_model(self):
        ...
        if self.kokoro is None:
            ...
            if not os.path.exists(self.model_path):
                raise FileNotFoundError(f"Kokoro model file not found at {self.model_path}. "
                                       f"Please download it from the Kokoro ONNX repository.")
    ...
    def create_stream(self, text: str, voice: str = "af_sarah", speed: float = 1.0) -> Generator[Dict[str, Any], None, None]:
        """
    ...
    def update_chunk(self, chunk_id: int, new_text: str, voice: str = "af_sarah", speed: float = 1.0) -> Tuple[str, List[Dict[str, Union[str, float]]]]:
        """
